...
const TruckEditForm = ({ formData, handleInputChange }) => {
  ...
  return (
    <div className='space-y-8'>
                        ...
                        <div className="border-b-2 ml-2 border-black w-full"></div>
                               ...
                               <div className="col-span-1 w-full flex flex-col mb-4 ">
                                <label className="block  text-md font-bold mb-2" htmlFor="vehicleType">Truck Type:</label>
                                 <select className="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline dark:bg-black" id="truckType" name="vehicleType" value={formData.vehicleType} onChange={handleInputChange} >
                        ...
                        <input className="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline dark:bg-black" type="number" id="trailerLength" name="trailerLength" value={formData.trailerLength} onChange={handleInputChange} />
                        </div>
                        </div>
                        ...
                        <select className="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline dark:bg-black" id="passengerCabin" name="passengerCabin" value={formData.passengerCabin} onChange={handleInputChange} >
                                    <option value="">Select</option>
                                    <option value="no">No</option> 
                                    <option value="available">Available</option>                
                        </select>
