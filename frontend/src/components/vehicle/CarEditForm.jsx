  ...
  return (
    <div className='space-y-8'>
        ...
        <p className="text-sm text-red-600 leading-relaxed">
            ...
            <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="carType" name="vehicleType" value={formData.vehicleType} onChange={handleInputChange}>
