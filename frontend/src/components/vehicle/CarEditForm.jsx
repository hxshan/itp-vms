...
const CarEditForm = ({ formData, handleInputChange }) => {
  ...
  return (
    <div className='space-y-8'>
        <h1 className="text-xl font-bold">Edit Car Details</h1>   
        ...
        <p className="text-sm text-red-600 leading-relaxed">
            ...
            <select className="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline dark:bg-black" id="carType" name="vehicleType" value={formData.vehicleType} onChange={handleInputChange}>
