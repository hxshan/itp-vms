  ...
  return (
    ...
    <div className='flex flex-row'>
          ...
          <div className="border-b-2 ml-2 border-black w-full"></div>
             ...
             <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lorryType" name="vehicleType" value={formData.vehicleType} onChange={handleInputChange} >
    ...
    <select className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="cargoArea" name="cargoArea" value={formData.cargoArea} onChange={handleInputChange} >
                <option value="">Select</option>
