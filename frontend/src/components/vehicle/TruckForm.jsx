...
const TruckForm = ({ formState, setFormState }) => {
    ...
    return (
      <div className='space-y-8'>
                        ...
                        <div className="border-b-2 ml-2 border-black w-full"></div>
                               ...
                               <div className="col-span-1 w-full flex flex-col mb-4 ">
                                <label className="block  text-md font-bold mb-2" htmlFor="vehicleType">Truck Type:</label>
                                 <select className="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline dark:bg-black" id="truckType" name="vehicleType" value={formState.vehicleType} onChange={handleChange} >
             ...
             <div>
             <label className="block  text-md font-bold mb-2 mt-4" htmlFor="otherTruckType">
                Other Truck Type:
             </label>
             <input 
