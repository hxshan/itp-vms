...
const BusForm = ({vehicleRegister,vehicleModel,vehicleManuYear,engineCap,lastMileage,vehicleColour,vehicleGearSys,airCon,numOfSeats,lugSpace,gps,fridge,tv,licEndDate,insEndDate,handleVehicleBookImageChange,handleVehicleLicenceImageImageChange,handleVehicleInsuImageChange}) => {
  return (
