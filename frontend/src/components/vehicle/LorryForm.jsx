...
const LorryForm = ({vehicleType,vehicleRegister,vehicleModel,vehicleManuYear,engineCap,lastMileage,vehicleWeight,cargoCapacity,cargoArea,vehicleGearSys,airCon,numOfSeats,gps,licEndDate,insEndDate,handleVehicleBookImageChange,handleVehicleLicenceImageImageChange,handleVehicleInsuImageChange}) => {
  return (
