  ...
  return (
    <div className='w-full place-content-center space-y-4 mt-8 bg-cover bg-center mb-10'>
      ...
      <div className='flex justify-end items-center'>
        ...
        <input type="date" value={searchDate} onChange={handleDateChange} className="mb-3 mr-4 shadow grow-0 appearance-none border rounded py-2 px-3  leading-tight focus:outline-none focus:shadow-outline"/>
      </div>
