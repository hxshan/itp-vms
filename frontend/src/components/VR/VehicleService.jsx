...
const VehicleService = () => {
  ...
  return (
    <div className='w-full place-content-center space-y-4 mt-8 bg-cover bg-center bg-white mb-10'>
        ...
        <div className='text-2xl font-bold text-black mt-4'>Type or Number</div>
      ...
      <table className='w-full border-collapse border-spacing-2 border-black rounded-md pad shadow-xl p-5'>
        <thead className='bg-gray-800 text-white'>
          ...
          <th className='border border-white p-2'>Vehicle Catagory</th>
            ...
            <th className='border border-white p-2'>Vehicle Lastmilage</th>
        ...
        {filteredVehicles.length > 0 ? (
            filteredVehicles.map(vehicle => (
              <tr className="bg-white border-t border-gray-200" key={vehicle._id}>
                ...
                <td className="px-6 py-2 whitespace-nowrap border-r border-gray-200">{vehicle.lastMileage}</td>
